...
def process_country(country, content_conjoint, bucket_name, storage_client):
    ...
    return question_category_single_df
...
def process_survey_data(request):
    ...
    for country, file in conjoint_filename_dict.items():
        ...
        if country in postcode_mapping_countries:
            ...
            location_df = pd.read_excel(content_location, sheet_name=country_code, skiprows=skip_row)
